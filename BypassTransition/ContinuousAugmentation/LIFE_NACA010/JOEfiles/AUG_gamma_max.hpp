#ifndef AUG_gamma_max_hpp
#define AUG_gamma_max_hpp

#include "LIFE/AugContainer.hpp"
#include "LIFE/AugMaps/PwMultiLinAugMap/PwMultiLinAugMap.hpp"

class GammaMaxAug : public AugContainer<PwMultiLinAugMap<3>, 3>
{
  public:

    GammaMaxAug() : AugContainer<PwMultiLinAugMap<3>, 3>() { }
    ...
    {
      this->vars = vars_;
      this->augMap.init("gamma_max", {46, 16, 16}, {0, 0, 0},
                        {3+1e-5, 1+1e-5, 1+1e-5});
